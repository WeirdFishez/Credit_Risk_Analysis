...
## Summary
As can be seen from the outputs above, the most successful models for our credit risk analysis came out to be our Ensemble models BalancedRandomForestClassifier and EasyEnsembleClassifier. All models had a high precision of .99, however this means nothing when they misses the 10-15 true fraudulent activities. Therefore We can look to the balanced accuracy score for both models which are leaders with .795. We can also look at the F1 score for both models which is a high .94-.95. This tells us that there is not a pronounced imbalance between sensitivity and precision.![image](https://user-images.githubusercontent.com/107438816/196533284-4486839f-8b32-45ba-b0d7-17ac14b27e4d.png)
